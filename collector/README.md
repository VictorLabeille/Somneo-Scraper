...
physique reste inconnu, à ne pas surfacer côté app avant de l'établir. 164 tests. **Reste** le
...
src/somneo_collector/
  __main__.py   un seul processus, un seul worker uvicorn, superviseur de découverte, battement
  outages.py    l'indisponibilité en cours : une seule, tenue au-dessus des redécouvertes
